...
static const VkShaderModuleCreateInfo shader_module_create_info = {
	...
	.pCode = elemmodbytwo_comp_data,
	.codeSize = sizeof(elemmodbytwo_comp_data),
};
...
void vulkan_kernel_elemmodbytwo_init(struct vulkan_ctx *vk) {
	struct vulkan_kernel *ini = &vk->kernels[VULKAN_KERNEL_TYPE_ELEMMODBYTWO];
