...
#include "nttfwdbutterfly.comp.h"
...
static const VkShaderModuleCreateInfo shader_module_create_info = {
	...
	.pCode = nttfwdbutterfly_comp_data,
	.codeSize = sizeof(nttfwdbutterfly_comp_data),
};
...
void vulkan_kernel_nttfwdbutterfly_init(struct vulkan_ctx *vk) {
	struct vulkan_kernel *ini = &vk->kernels[VULKAN_KERNEL_TYPE_NTTFWDBUTTERFLY];
