...
static const VkShaderModuleCreateInfo shader_module_create_info = {
	...
	.pCode = elemmulconst_comp_data,
	.codeSize = sizeof(elemmulconst_comp_data),
};
...
void vulkan_kernel_elemmulconst_init(struct vulkan_ctx *vk) {
	struct vulkan_kernel *ini = &vk->kernels[VULKAN_KERNEL_TYPE_ELEMMULCONST];
